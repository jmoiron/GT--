...
import static dev.arbor.gtnn.data.GTNNRecipeTypes.*;
...
public class NaquadahLine {
    ...
    public static void epLine(Consumer<FinishedRecipe> consumer) {
        ...
        MIXER_RECIPES.recipeBuilder("palladium_on_carbon")
                ...
                .circuitMeta(32)
                .duration(GTNNRecipes.dur(8)).EUt(VA[HV]).save(consumer);
