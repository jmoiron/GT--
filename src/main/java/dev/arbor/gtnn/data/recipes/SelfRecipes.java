...
public class SelfRecipes {
    ...
    private static void materialRecipes(Consumer<FinishedRecipe> provider) {
        DefaultRecipes.addBOOMRecipes("enriched_uranium_nugget", GTNNItems.EncapsulatedUranium, GTNNItems.EnrichedUraniumNugget, GTNNRecipes.dur(1), 1, provider);
        DefaultRecipes.addBOOMRecipes("enriched_thorium_nugget", GTNNItems.EncapsulatedThorium, GTNNItems.EnrichedThoriumNugget, GTNNRecipes.dur(1), 1, provider);
        DefaultRecipes.addBOOMRecipes("enriched_plutonium_nugget", GTNNItems.EncapsulatedPlutonium, GTNNItems.EnrichedPlutoniumNugget, GTNNRecipes.dur(1), 1, provider);
        GTNNRecipeTypes.PRECISION_ASSEMBLY_RECIPES.recipeBuilder("quark_core")
                ...
                .EUt(VA[LuV]).duration(GTNNRecipes.dur(5)).save(provider);
        MIXER_RECIPES.recipeBuilder("graphite_uranium_mixture")
                ...
                .EUt(VA[LV]).duration(GTNNRecipes.dur(1.7)).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("encapsulated_uranium")
                ...
                .EUt(VA[HV]).duration(GTNNRecipes.dur(70)).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("uranium_carbide_thorium_mixture")
                ...
                .EUt(VA[LV]).duration(GTNNRecipes.dur(2.35)).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("encapsulated_thorium")
                ...
                .EUt(VA[HV]).duration(GTNNRecipes.dur(15)).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("plutonium_oxide_uranium_mixture")
                ...
                .EUt(VA[LV]).duration(GTNNRecipes.dur(1.25)).save(provider);
        ...
        COMPRESSOR_RECIPES.recipeBuilder("enriched_uranium")
                ...
                .EUt(VA[HV]).duration(GTNNRecipes.dur(30)).save(provider);
        COMPRESSOR_RECIPES.recipeBuilder("enriched_thorium")
                ...
                .EUt(VA[MV]).duration(GTNNRecipes.dur(10)).save(provider);
        COMPRESSOR_RECIPES.recipeBuilder("enriched_plutonium")
                ...
                .EUt(VA[MV]).duration(GTNNRecipes.dur(60)).save(provider);
        FUSION_RECIPES.recipeBuilder("californium")
                ...
                .EUt(VA[ZPM]).duration(GTNNRecipes.dur(12)).save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("inverter")
                ...
                .EUt(VA[MV]).duration(GTNNRecipes.dur(12)).save(provider);
        MIXER_RECIPES.recipeBuilder("thorium_based_liquid_fuel")
                ...
                .circuitMeta(2)
                .EUt(VHA[HV]).duration(GTNNRecipes.dur(150)).save(provider);
        ...
        MIXER_RECIPES.recipeBuilder("thorium_based_liquid_fuel_excited")
                ...
                .circuitMeta(1)
                .EUt(VHA[IV]).duration(GTNNRecipes.dur(6)).save(provider);
        GTNNRecipeTypes.NEUTRON_ACTIVATOR_RECIPES.recipeBuilder("uranium_based_liquid_fuel_excited")
                ...
                .duration(GTNNRecipes.dur(4)).save(provider);
        FUSION_RECIPES.recipeBuilder("uranium_based_liquid_fuel_excited")
                ...
                .EUt(VA[IV]).duration(GTNNRecipes.dur(2)).save(provider);
        ...
        FUSION_RECIPES.recipeBuilder("plutonium_based_liquid_fuel_excited")
                ...
                .EUt(VA[LuV]).duration(GTNNRecipes.dur(1)).save(provider);
        GTNNRecipeTypes.NEUTRON_ACTIVATOR_RECIPES.recipeBuilder("thorium_based_liquid_fuel_depleted")
                ...
                .duration(GTNNRecipes.dur(500)).save(provider);
        GTNNRecipeTypes.LARGE_NAQUADAH_REACTOR_RECIPES.recipeBuilder("thorium_based_liquid_fuel_depleted")
                ...
                .EUt(-2200)
                .duration(GTNNRecipes.dur(25)).save(provider);
        GTNNRecipeTypes.LARGE_NAQUADAH_REACTOR_RECIPES.recipeBuilder("uranium_based_liquid_fuel_depleted")
                ...
                .EUt(-12960)
                .duration(GTNNRecipes.dur(5)).save(provider);
        ...
        CENTRIFUGE_RECIPES.recipeBuilder("uranium_based_liquid_fuel_depleted")
                ...
                .circuitMeta(1)
                .EUt(1040).duration(GTNNRecipes.dur(50)).save(provider);
        CENTRIFUGE_RECIPES.recipeBuilder("plutonium_based_liquid_fuel_depleted")
                ...
                .circuitMeta(1)
                .EUt(VA[IV]).duration(GTNNRecipes.dur(125)).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("plate_radiation")
                ...
                .circuitMeta(1)
                .EUt(VA[EV]).duration(GTNNRecipes.dur(20)).save(provider);
        ...
        MIXER_RECIPES.recipeBuilder("naquadah_based_liquid_fuel")
                ...
                .EUt(VA[IV]).duration(GTNNRecipes.dur(15)).save(provider);
        FUSION_RECIPES.recipeBuilder("naquadah_based_liquid_fuel_excited")
                ...
                .EUt(26000).duration(GTNNRecipes.dur(25)).save(provider);
        GTNNRecipeTypes.LARGE_NAQUADAH_REACTOR_RECIPES.recipeBuilder("naquadah_based_liquid_fuel_depleted")
                ...
                .EUt(-975_000L)
                .duration(GTNNRecipes.dur(3)).save(provider);
        CENTRIFUGE_RECIPES.recipeBuilder("naquadah_based_liquid_fuel_depleted")
                ...
                .EUt(VA[EV]).duration(GTNNRecipes.dur(30)).save(provider);
        GTNNRecipeTypes.CHEMICAL_PLANT_RECIPES.recipeBuilder(GTNNMaterials.Thorium232.getName())
                ...
                .outputItems(dust, GTNNMaterials.Thorium232, 2)
                .chancedOutput(dustSmall, GTNNMaterials.Thorium232, 2, 1000, 0)
                //.chancedOutput(dustSmall, Uranium232, 2, 1000, 0)
                .addCondition(GTNNRecipes.setPlantCasing(5))
                .circuitMeta(1)
                .EUt(VA[EV]).duration(GTNNRecipes.dur(300)).save(provider);
        CHEMICAL_RECIPES.recipeBuilder("ammonium_chloride")
                .inputFluids(Ammonia.getFluid(1000))
                .inputFluids(HydrochloricAcid.getFluid(1000))
                .outputFluids(AmmoniumChloride.getFluid(1000))
                .circuitMeta(1)
                .EUt(VA[LV]).duration(GTNNRecipes.dur(0.75)).save(provider);
    }
    ...
    private static void blockRecipes(Consumer<FinishedRecipe> provider) {
        ...
        ASSEMBLER_RECIPES.recipeBuilder("high_speed_pipe_block")
                ...
                .EUt(VA[EV]).duration(GTNNRecipes.dur(15)).save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("frame_radiation")
                ...
                .circuitMeta(24)
                .EUt(VA[EV]).duration(GTNNRecipes.dur(16)).save(provider);
        MIXER_RECIPES.recipeBuilder("neutronium_mixture")
                .inputItems(dust, GTNNMaterials.NeutroniumMixture)
                .inputFluids(Helium.getFluid(FluidStorageKeys.PLASMA, 144))
                .outputItems(dust, Neutronium)
                .circuitMeta(1)
                .EUt(VA[ZPM]).duration(GTNNRecipes.dur(11.25)).save(provider);
        VanillaRecipeHelper.addShapelessRecipe(provider, "centrifuged_ore_to_dust_neutronium",
                ChemicalHelper.get(dust, GTNNMaterials.NeutroniumMixture), 'h', ChemicalHelper.get(crushedRefined, Neutronium));
    }
    ...
    private static void machineRecipes(Consumer<FinishedRecipe> provider) {
        ASSEMBLY_LINE_RECIPES.recipeBuilder("large_naquadah_reactor")
                ...
                .EUt(VA[ZPM]).duration(GTNNRecipes.dur(210)).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("neutron_accelerator_mv")
                ...
                .outputItems(GTNNMachines.NEUTRON_ACCELERATOR[MV].asStack())
                .EUt(VA[MV]).duration(GTNNRecipes.dur(15)).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("neutron_accelerator_hv")
                ...
                .outputItems(GTNNMachines.NEUTRON_ACCELERATOR[HV].asStack())
                .EUt(VA[HV]).duration(GTNNRecipes.dur(15)).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("neutron_accelerator_ev")
                ...
                .outputItems(GTNNMachines.NEUTRON_ACCELERATOR[EV].asStack())
                .EUt(VA[EV]).duration(GTNNRecipes.dur(15)).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("neutron_accelerator_iv")
                ...
                .outputItems(GTNNMachines.NEUTRON_ACCELERATOR[IV].asStack())
                .EUt(VA[IV]).duration(GTNNRecipes.dur(15)).save(provider);
        ASSEMBLY_LINE_RECIPES.recipeBuilder("neutron_accelerator_luv")
                ...
                .outputItems(GTNNMachines.NEUTRON_ACCELERATOR[LuV].asStack())
                .EUt(VA[LuV]).duration(GTNNRecipes.dur(15)).save(provider);
        ASSEMBLY_LINE_RECIPES.recipeBuilder("neutron_accelerator_zpm")
                ...
                .outputItems(GTNNMachines.NEUTRON_ACCELERATOR[ZPM].asStack())
                .EUt(VA[ZPM]).duration(GTNNRecipes.dur(15)).save(provider);
        ASSEMBLY_LINE_RECIPES.recipeBuilder("neutron_accelerator_uv")
                ...
                .outputItems(GTNNMachines.NEUTRON_ACCELERATOR[UV].asStack())
                .EUt(VA[UV]).duration(GTNNRecipes.dur(15)).save(provider);
        ...
        GTNNRecipeTypes.PRECISION_ASSEMBLY_RECIPES.recipeBuilder("neutron_activator")
                ...
                .EUt(VA[IV]).duration(GTNNRecipes.dur(5)).save(provider);
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "neutron_accelerator_ulv", GTNNMachines.NEUTRON_ACCELERATOR[ULV].asStack(),
                "ABC", "DEF", "ABC",
        ...
        VanillaRecipeHelper.addShapedRecipe(provider, "neutron_accelerator_lv", GTNNMachines.NEUTRON_ACCELERATOR[LV].asStack(),
                "ABC", "DEF", "ABC",
