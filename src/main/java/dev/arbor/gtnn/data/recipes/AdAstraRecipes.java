...
public class AdAstraRecipes {
    public static void init(Consumer<FinishedRecipe> provider) {
        ...
        ASSEMBLER_RECIPES.recipeBuilder("heavy_ingot_t2")
                ...
                .circuitMeta(1)
                .duration(GTNNRecipes.dur(15)).EUt(VA[EV]).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("heavy_ingot_t3")
                ...
                .circuitMeta(1)
                .duration(GTNNRecipes.dur(15)).EUt(VA[IV]).save(provider);
        ASSEMBLY_LINE_RECIPES.recipeBuilder("heavy_ingot_t4")
                ...
                .duration(GTNNRecipes.dur(15)).EUt(VA[LuV]).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("space_helmet")
                ...
                .EUt(VA[MV]).duration(GTNNRecipes.dur(20)).save(provider);
        ASSEMBLER_RECIPES.recipeBuilder("netherite_space_helmet")
                ...
                .inputFluids(StainlessSteel.getFluid(72))
                .EUt(VA[HV]).duration(GTNNRecipes.dur(10)).save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("jet_suit_helmet")
                ...
                .EUt(VA[EV]).duration(GTNNRecipes.dur(10)).save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("ostrum_engine")
                ...
                .EUt(VA[IV]).duration(GTNNRecipes.dur(10)).save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("steel_tank")
                ...
                .circuitMeta(1)
                .EUt(VA[LV]).duration(GTNNRecipes.dur(1)).save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("rocket_nose_cone")
                ...
                .circuitMeta(4)
                .EUt(VA[LV]).duration(GTNNRecipes.dur(2.5)).save(provider);
        ...
        ASSEMBLER_RECIPES.recipeBuilder("steel_engine")
                ...
                .EUt(VA[LV]).duration(GTNNRecipes.dur(5)).save(provider);
        ...
        ASSEMBLY_LINE_RECIPES.recipeBuilder("calorite_engine")
                ...
                .EUt(VA[LuV]).duration(GTNNRecipes.dur(30)).save(provider);
    }
