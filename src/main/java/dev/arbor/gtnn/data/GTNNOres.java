...
import static dev.arbor.gtnn.data.GTNNWorld.*;
import static dev.arbor.gtnn.data.GTNNWorld.GTNNWorldGenLayers.AD;
import static dev.arbor.gtnn.data.GTNNWorld.GTNNWorldGenLayers.TF;
...
public class GTNNOres {
    ...
    private static ResourceLocation twilightForest() {
        return GTNNIntegration.INSTANCE.isTwilightForestLoaded() ? TWILIGHT_FOREST : BuiltinDimensionTypes.OVERWORLD.location();
    }
