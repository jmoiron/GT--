...
object GTNNOres {
        ...
        { vein: GTOreDefinition ->
            vein
                ...
                .layeredVeinGenerator { generator: LayeredVeinGenerator ->
                    generator
                        .buildLayerPattern { pattern: GTLayerPattern.Builder ->
                            pattern
    ...
    val MONAZITE_VEIN_N: GTOreDefinition = create(
        ...
        vein
            .clusterSize(24)
            .weight(30)
            .layer(GTNNWorldGenLayers.AD)
            .density(0.2f)
            .dimensions(GTNNWorld.MOON, GTNNWorld.VENUS, GTNNWorld.GLACIO)
    ...
    val QUARTZITE_VEIN: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.3f)
            .dimensions(GTNNWorld.MOON, GTNNWorld.MARS, GTNNWorld.VENUS)
    ...
    val MOLYBDENUM_VEIN_AD: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.25f)
            .dimensions(GTNNWorld.MOON, GTNNWorld.MERCURY)
    ...
    val GALENA_VEIN_AD: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.25f)
            .dimensions(GTNNWorld.MOON, GTNNWorld.MARS, GTNNWorld.VENUS, GTNNWorld.GLACIO)
    ...
    val CASSITERITE_VEIN_AD: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.4f)
            .dimensions(GTNNWorld.MOON, GTNNWorld.VENUS)
            .heightRangeUniform(10, 80)
            .discardChanceOnAirExposure(0f)
            .layeredVeinGenerator { generator: LayeredVeinGenerator ->
                generator
    ...
    val PITCHBLENDE_VEIN_AD: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.2f)
            .dimensions(GTNNWorld.MARS, GTNNWorld.VENUS)
    ...
    val TUFF_URANINITE_VEIN_AD: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.2f)
            .dimensions(GTNNWorld.MARS, GTNNWorld.MERCURY)
    ...
    val SCHEELITE_VEIN_AD: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.2f)
            .dimensions(GTNNWorld.MARS, GTNNWorld.GLACIO)
            .heightRangeUniform(20, 60)
            .discardChanceOnAirExposure(0f)
            .layeredVeinGenerator { generator: LayeredVeinGenerator ->
                generator
    ...
    val NICKEL_VEIN_AD: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.25f)
            .dimensions(GTNNWorld.MARS, GTNNWorld.VENUS, GTNNWorld.GLACIO)
    ...
    val MAGNETITE_VEIN_AD: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.15f)
            .dimensions(GTNNWorld.MARS, GTNNWorld.MERCURY, GTNNWorld.GLACIO)
            .heightRangeUniform(10, 60)
            .discardChanceOnAirExposure(0f)
            .layeredVeinGenerator { generator: LayeredVeinGenerator ->
                generator
    ...
    val BERYLLIUM_VEIN_AD: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.2f)
            .dimensions(GTNNWorld.MARS, GTNNWorld.MERCURY, GTNNWorld.VENUS)
    ...
    val MANGANESE_VEIN_AD: GTOreDefinition = create(
        ...
        vein
            ...
            .layer(GTNNWorldGenLayers.AD)
            .density(0.2f)
            .dimensions(GTNNWorld.MERCURY, GTNNWorld.GLACIO)
            .heightRangeUniform(-30, 0)
            .discardChanceOnAirExposure(0f)
            .layeredVeinGenerator { generator: LayeredVeinGenerator ->
                generator
